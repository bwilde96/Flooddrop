...
const CHALLENGES := {
	0: [ # WATER — purity & rhythm
		...
		{"id": "w2", "name": "Cloudburst", "desc": "Bursts of rain every few seconds. Reach 800 points.",
			"mods": {"no_powerups": true, "frenzy_every": 6.0, "spawn_mult": 1.2},
	...
	1: [ # SLIME — chaos & bounce
		...
		{"id": "sboss", "name": "⚔ Slime King's Court", "desc": "BOSS: the King splits and splits again. End the bloodline.",
			"mods": {"spawn_mult": 1.2}, "win": {"type": "boss", "value": 0.0}, "is_boss": true,
	...
	4: [ # GOLD — greed
		{"id": "g1", "name": "Gold Fever", "desc": "Gold accelerates as it falls. Survive 50s.",
			...
			"rewards": {"droplets": 400, "cores": 1}},
		{"id": "g2", "name": "Coin Storm", "desc": "Burst waves of coins. Reach a 4x combo.",
			"mods": {"frenzy_every": 5.0, "spawn_mult": 1.2}, "win": {"type": "combo", "value": 4.0},
			"rewards": {"droplets": 500, "cores": 1}},
	...
	5: [ # RAINBOW — light & dark
		...
		{"id": "r2", "name": "Chasing Light", "desc": "Blackout + swaying drops. Pop 40.",
			"mods": {"force_event": "prismatic", "sway": 120.0}, "win": {"type": "pops", "value": 40.0},
			"rewards": {"droplets": 550, "cores": 1}},
	...
	6: [ # NEON — glitch
		{"id": "n1", "name": "Signal Noise", "desc": "Everything stutters and teleports. Survive 45s.",
			"mods": {"force_event": "overdrive"}, "win": {"type": "survive", "value": 45.0},
			"rewards": {"droplets": 500, "cores": 1}},
		...
		{"id": "nboss", "name": "⚔ The Mainframe", "desc": "BOSS: purge three corrupted waves, then crash the core.",
			"mods": {"force_event": "overdrive"}, "win": {"type": "boss", "value": 0.0}, "is_boss": true,
			"rewards": {"droplets": 1800, "cores": 3, "prisms": 20}},
	],
	7: [ # GALAXY — chaos incarnate
		{"id": "x1", "name": "Event Horizon", "desc": "Giant heavy drops, huge damage. Survive 45s.",
			"mods": {"damage_mult": 1.5}, "win": {"type": "survive", "value": 45.0},
			"rewards": {"droplets": 600, "cores": 1}},
