...
const CHALLENGES := {
	...
	2: [ # LAVA — barrage & heat
		...
		{"id": "lboss", "name": "⚔ The Magma Core", "desc": "BOSS: it fires volleys from behind a shield — strike when it opens.",
			"mods": {"damage_mult": 1.3}, "win": {"type": "boss", "value": 0.0}, "is_boss": true, "boss_type": "core",
	...
	3: [ # ACID — corrosion & restraint
		...
		{"id": "aboss", "name": "⚔ The Hydra Vat", "desc": "BOSS: three heads, one beating heart. Strike true — decoys spit back.",
			"mods": {}, "win": {"type": "boss", "value": 0.0}, "is_boss": true, "boss_type": "hydra",
	...
	4: [ # GOLD — greed
		...
		{"id": "gboss", "name": "⚔ The Coin Cannon", "desc": "BOSS: it fires CLOCKWORK volleys — pop them on the beat while you break the core.",
			"mods": {"core_volley": 11}, "win": {"type": "boss", "value": 0.0}, "is_boss": true, "boss_type": "core",
	...
	5: [ # RAINBOW — light & dark
		...
		{"id": "rboss", "name": "⚔ The Eclipse Core", "desc": "BOSS: in total darkness, IT is the only light. Survive its volleys, strike its heart.",
			"mods": {"force_event": "prismatic"}, "win": {"type": "boss", "value": 0.0}, "is_boss": true, "boss_type": "core",
	...
	6: [ # NEON — glitch
		{"id": "n1", "name": "Ghost Packets", "desc": "Phantom drops phase through your taps. Survive 45s.",
			...
			"rewards": {"droplets": 500, "cores": 1}},
		{"id": "n2", "name": "Corrupted Beat", "desc": "Glitching CLOCKWORK drops — find the rhythm inside the noise. Reach 1500.",
			"mods": {"force_event": "overdrive", "special_rain": "clockwork"}, "win": {"type": "score", "value": 1500.0},
	...
	7: [ # GALAXY — chaos incarnate
		...
		{"id": "x3", "name": "Singularity", "desc": "Phantoms, frenzy, speed — everything at once. Reach a 5x combo.",
			"mods": {"frenzy_every": 6.0, "speed_mult": 1.2, "spawn_mult": 1.2, "special_rain": "phantom"},
			"win": {"type": "combo", "value": 5.0}, "rewards": {"droplets": 900, "cores": 2}},
		{"id": "xboss", "name": "⚔ The Cosmic Warden", "desc": "BOSS: the final titan. It cracks. It rages. It will not go quietly.",
			"mods": {"spawn_mult": 1.25, "speed_mult": 1.1, "special_rain": "shielded"},
			"win": {"type": "boss", "value": 0.0}, "is_boss": true,
